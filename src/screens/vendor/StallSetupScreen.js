...
export default function StallSetupScreen({navigation}){
    ...
    const [businessHours, setBusinessHours]=useState({
        Monday:{open:'9:00',close:'21:00',closed:false},
        Tuesday:{open:'9:00',close:'21:00',closed:false},
        Wednesday:{open:'9:00',close:'21:00',closed:false},
        Thursday:{open:'9:00',close:'21:00',closed:false},
        Friday:{open:'9:00',close:'21:00',closed:false},
        Saturday:{open:'9:00',close:'21:00',closed:false},
    ...
    const loadStallData=async()=>{
        try{
            ...
            if (vendorDoc.exists()){
                ...
                setDeliveryRadius(data.deliveryRadius?.toString()||'10');
