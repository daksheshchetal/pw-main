...
export default function EarningsScreen({navigation}){
    ...
    const fetchEarnings=async()=>{
        ...
        try{
            ...
            txList.sort((a,b)=> b.createdAt?.seconds-
            a.createdAt?.seconds);
                setEarnings({
                    total,
                    cash,
    ...
    const renderPaymentBar=()=>{
        ...
        return(
            <View style={styles.paymentBar}>
                {cash>0 && (
                    <View style={[styles.paymentSegment,{width:`${cashPercent}%`,
                    backgroundColor:'#4CAF50'}]}/>
                )}
                {upi > 0 && (
                    <View style={[styles.paymentSegment,{width:`${upiPercent}%`,
                    backgroundColor:'#2196F3'}]}/>
                )}
                {card > 0 && (
                    <View style={[styles.paymentSegment, {width:`${cardPercent}%`,
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.breakdownGrid}>
                            <View style={styles.breakdownCard}>
                                ...
                                >{formatCurrency(earnings.cash)}</Text>
                            ...
                            <View style={styles.breakdownCard}>
                                ...
                                <Text style={styles.breakdownAmount}
                                >{formatCurrency(earnings.upi)}</Text>
                                <Text style={styles.breakdownPercent}>
                            ...
                            <View style={styles.breakdownCard}>
                                ...
                                <Text style={styles.breakdownAmount}
                                >{formatCurrency(earnings.card)}</Text>
                                <Text style={styles.breakdwonPercent}>
